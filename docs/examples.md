...
| [`examples/selective-disclosure-encrypted-source/`](../examples/selective-disclosure-encrypted-source/) | Native | `okpf-core` | Public records, redacted source excerpt, encrypted source placeholder, derivation report, and evaluation plan without requiring decryption for Core validation. |
